//
//  VolumeEntity+CoreDataProperties.h
//  testPods
//
...
@interface VolumeEntity (CoreDataProperties)

@property (nullable, nonatomic, retain) NSString *volumeID;
@property (nullable, nonatomic, retain) NSString *volumeName;
@property (nullable, nonatomic, retain) NSSet<ExerciseEntity *> *exercise;

@end

@interface VolumeEntity (CoreDataGeneratedAccessors)
