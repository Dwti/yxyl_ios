...
@interface YXQAProgressView_Pad()
@property (nonatomic, strong) UIButton *preButton;
@property (nonatomic, strong) UIButton *nextButton;
@property (nonatomic, strong) UILabel *progressLabel;
@end

@implementation YXQAProgressView_Pad
...
- (void)updateWithIndex:(NSInteger)index total:(NSInteger)total{
    ...
    NSString *completeString = [NSString stringWithFormat:@"第 %@ 题 / 共%@题",indexString,totalString];
