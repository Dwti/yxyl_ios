//
//  YXMineBaseViewController_Pad.m
//  YanXiuStudentApp
//
...
@interface YXMineBaseViewController_Pad ()

@end

@implementation YXMineBaseViewController_Pad
...
- (void)loadView
{
    ...
    UIImageView *bgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"我的背景-Pad"]];
