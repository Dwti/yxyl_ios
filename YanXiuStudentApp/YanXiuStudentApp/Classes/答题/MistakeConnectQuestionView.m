...
@interface MistakeConnectQuestionView ()
...
@property (nonatomic, copy) MistakeConnectQuestionAnswerStateChangeBlock block;

@end

@implementation MistakeConnectQuestionView
