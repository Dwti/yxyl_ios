...
@interface MistakeClassifyQuestionView()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@property (nonatomic, copy) MistakeClassifyQuestionAnswerStateChangeBlock block;

@end

@implementation MistakeClassifyQuestionView
